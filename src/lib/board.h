...
#define SYNC_DETECT_PINMUX IOMUXC_GPIO_05_GPIOMUX_IO05
#define SYNC_DETECT_PORT GPIO1
#define SYNC_DETECT_PIN 5U
#define SYNC_IN_PINMUX IOMUXC_GPIO_AD_00_GPIOMUX_IO14
#define SYNC_IN_PORT GPIO1
#define SYNC_IN_PIN 14
#define SYNC_OUT_PINMUX IOMUXC_GPIO_AD_01_GPIOMUX_IO15
#define SYNC_OUT_PORT GPIO1
#define SYNC_OUT_PIN 15U
