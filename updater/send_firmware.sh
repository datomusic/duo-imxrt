...
echo "erasing flash"
blhost -u 0x15A2,0x0073 -- flash-erase-region 0x60001000 128000
echo "done"

echo "writing binary"
blhost -u 0x15A2,0x0073 -- write-memory 0x60001000 ../src/duo-imxrt/build/flexspi_nor_debug/out.bin
echo "done"
